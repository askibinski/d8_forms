...
namespace Drupal\my_yamlform_element\Plugin\YamlFormElement;
...
/**
 * Provides a 'albert' element.
 *
 * @YamlFormElement(
 *   id = "albert",
 *   label = @Translation("Albert element"),
 * )
 */
class Albert extends YamlFormElementBase {
